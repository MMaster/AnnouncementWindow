...
class config(object):
    ...
    def load(self):
        if not os.path.exists(self.filepath):
            ...
            self.parser.set("Settings", 'trim_announcements_2', str(self.trim_announcements[2]))
            ...
            self.trim_announcements[2] = self.parser.getint("Settings", 'trim_announcements_2')
